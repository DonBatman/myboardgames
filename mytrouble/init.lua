...
core.register_node("mytrouble:dot_"..col,{
...
core.register_node("mytrouble:squ_"..col,{
	description = desc.." Dot",
	tiles = {
...
core.register_node("mytrouble:"..item,{
	description = desc.." Player",
	tiles = {"default_gravel.png"..col},
	drawtype = "mesh",
	mesh = "mytrouble_piece.obj",
	paramtype = "light",
	light_source = 11,
...
core.register_node("mytrouble:placer",{
	description = "Trouble",
	...
	local schem = core.get_modpath("mytrouble").."/schems/mytrouble.mts"
		core.place_schematic({x=pos.x-1,y=pos.y,z=pos.z-1},schem,0, "air", true)
	end,
...
dofile(core.get_modpath("mytrouble").."/dice.lua")
