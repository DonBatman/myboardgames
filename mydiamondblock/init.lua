core.register_node("mydiamondblock:block",{
	...
	local schem = core.get_modpath("mydiamondblock").."/schems/mydiamondblock.mts"
...
for blues = 1,6 do
local blue = blues
core.register_node("mydiamondblock:blue"..blue,{
...
for browns = 1,4 do
local brown = browns
core.register_node("mydiamondblock:brown"..brown,{
