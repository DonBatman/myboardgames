...
core.register_node("mycheckers:board", {
	...
	local schem = core.get_modpath("mycheckers").."/schems/mycheckersboard.mts"
...
core.register_node("mycheckers:redp_c", {
...
core.register_node("mycheckers:blackp_c", {
...
core.register_node("mycheckers:blackp", {
...
after_place_node = function(pos, placer, itemstack, pointed_thing)
	...
	if nodeu.name == "mycheckers:blackp" and
	   ...
	   core.set_node({x=pos.x,y=pos.y-1,z=pos.z},{name = "mycheckers:blackp_c"})
	   core.set_node(pos,{name = "air"})
	elseif nodeu ~= "mycheckers:blackp" then
		core.set_node(pos,{name="mycheckers:blackp"})
	end
	
end
})
core.register_node("mycheckers:redp", {
...
after_place_node = function(pos, placer, itemstack, pointed_thing)
	...
	if 	nodeu.name == "mycheckers:redp" and
	   	...
	   	core.set_node({x=pos.x,y=pos.y-1,z=pos.z},{name = "mycheckers:redp_c"})
	   	core.set_node(pos,{name = "air"})
	elseif nodeu ~= "mycheckers:redp" then
		core.set_node(pos,{name="mycheckers:redp"})
	end
