core.register_node("mymazes:block1",{
	description = "Maze 1",
	...
	local schem = core.get_modpath("mymazes").."/schems/mymaze1.mts"
...
core.register_node("mymazes:block2",{
	description = "Maze 2",
	...
	groups = {cracky = 1},
	on_rightclick = function(pos, node, player, itemstack, pointed_thing)
	local schem = core.get_modpath("mymazes").."/schems/mymaze2.mts"	
		core.place_schematic(pos,schem,0, "air", true)
	end,
	after_place_node = function(pos, placer, itemstack, pointed_thing)
		if placer and core.check_player_privs(placer:get_player_name(), {myboardgames = true}) then
